		...
		*/
        ...
        while(true) // Just keep polling for the user's input.
        {
            ...
            switch(cmd)
            {
                ...
                case "A":
                    paxos.broadcastTOMsg(new Object[] { playerNum, "L".charAt(0) });
                    break;
                case "W":
                    paxos.broadcastTOMsg(new Object[] { playerNum, "U".charAt(0) });
                    break;
                case "S":
                    paxos.broadcastTOMsg(new Object[] { playerNum, "D".charAt(0) });
                    break;
                case "D": 
                    paxos.broadcastTOMsg(new Object[] { playerNum, "R".charAt(0) });
                    break;
		...
		ta.tiThread.join(1000); // Wait maximum 1 second for the app to process any more incomming messages that was in the queue.
